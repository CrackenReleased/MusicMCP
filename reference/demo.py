...
def run():
    ...
    observation = workspace.observe(evidence.id, 'Synthetic demonstration: supplied A4 observation; no analyzer ran.')
    ...
    workspace.propose(observation.id, 'opening', triplet.notes, 'intended', 'HIGH', 'interpreted')
