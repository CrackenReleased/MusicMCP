...
## Current status: v0.1.01 experimental foundation, analyzer, spectrum watcher, MCP transport, format adapters, durable storage, host CLI & multi-role collaboration
